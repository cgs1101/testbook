    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transit_price', models.DecimalField(max_digits=10, decimal_places=2, verbose_name='商品总价')),
                ('pay_method', models.SmallIntegerField(default=1, choices=[(1, '货到付款'), (2, '微信支付'), (3, '支付宝'), (4, '银联支付')], verbose_name='支付方式')),
                ('status', models.SmallIntegerField(default=1, choices=[(5, '已完成'), (2, '待发货'), (3, '待收货'), (1, '待支付'), (4, '待评价')], verbose_name='订单状态')),
                ('trade_id', models.CharField(max_length=100, unique=True, blank=True, null=True, verbose_name='订单编号')),
